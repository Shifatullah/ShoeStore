...
[securestring] $clientPasswordSecure1 = ConvertTo-SecureString -String '$(variables.test)' -AsPlainText -Force
write-host $clientPasswordSecure1

[securestring] $clientPasswordSecure2 = ConvertTo-SecureString -String '$(test)' -AsPlainText -Force
write-host $clientPasswordSecure2

[securestring] $clientPasswordSecure3 = ConvertTo-SecureString -String '${{ variables.test }}' -AsPlainText -Force
write-host $clientPasswordSecure3

[securestring] $clientPasswordSecure4 = ConvertTo-SecureString -String '${{ test }}' -AsPlainText -Force
write-host $clientPasswordSecure4

[securestring] $clientPasswordSecure5 = ConvertTo-SecureString -String $env:TEST -AsPlainText -Force
write-host $clientPasswordSecure5

[securestring] $clientPasswordSecure6 = ConvertTo-SecureString -String '$env:test' -AsPlainText -Force
write-host $clientPasswordSecure6

[securestring] $clientPasswordSecure7 = ConvertTo-SecureString -String '$(env:test)' -AsPlainText -Force
write-host $clientPasswordSecure7

[securestring] $clientPasswordSecure8 = ConvertTo-SecureString -String '${{ env:test }}' -AsPlainText -Force
